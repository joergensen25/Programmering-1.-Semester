package main.java.semester2.lektion16.eksempler;
...
public class HelperMethods {
	...
	// Hjælpemetode opgave 1:
	public static int ligeTalHelper(ArrayList<Integer> list, int index) {
		...
		return count + ligeTalHelper(list, index + 1);
	}
