package semester1.lektioner.lektion30.opgave.models;
...
public class Student extends Person {
    ...
    public Student(String name, String address, String qualification, double gradeAverage, String studentId) {
        // kalder constructoren i
        // superklassen, dette kald skal ske som det første i metoden
        super(name, address, qualification);
        this.gradeAverage = gradeAverage; // attributten i subklassen får en værdi
    ...
    public void udskrivPerson() {
        // løsning på udskriv, hvor vi
        // udnytter, at der er en udskriv i superklassen
        super.udskrivPerson(); // nødvendigt med super for ikke at kalde sig selv.
